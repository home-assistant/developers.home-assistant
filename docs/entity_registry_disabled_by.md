...
Integrations can offer options to users either via [configuration.yaml](/core/integration/yaml_configuration.md) or using an [Options Flow](/core/integration/options_flow.md).
