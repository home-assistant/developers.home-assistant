...
- [Docker](https://docs.docker.com/install/) or [Podman](https://podman.io/getting-started/installation)
...
If you are an experienced developer already using Visual Studio code and already have a fork of the
repository checked out in a workspace, simply click on the Remote extension and then click "Open Workspace in Container"

### Automatic Setup

If you don't know what the words above mean, or if you want VScode to check out the repo and do everything for you:
