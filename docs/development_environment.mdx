...
*Note:* as this approach uses containers, you may face challenges exposing hardware like USB-devices & adapters (on-board Bluetooth, Zigbee, ...) into the container for testing. This is in general possible when developing on a Linux-host, but you will not be able to directly access such hardware if you are using a Windows or MacOS computer for development.
