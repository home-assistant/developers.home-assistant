...
If you encounter crash (`SIGKILL`) while running this command on *macOS* it's probably about lack of Bluetooth permission. You can fix it by adding this permission for your Terminal app (System Preferences -> Security & Privacy -> Bluetooth).
