...
3. Click "+" button to "Create a codespace on dev"
...
5. A very basic configuration.yaml is created in the folder `/config`. We need to make a modification in this file.
