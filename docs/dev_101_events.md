...
To fire an event, you have to interact with the event bus. The event bus is available on the Home Assistant instance as `hass.bus`. Please be mindful of the data structure as mentioned in the [Data Docs](https://data.home-assistant.io/docs/events/#database-table).
