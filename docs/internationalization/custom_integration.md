...
The language codes follow the [BCP47](https://tools.ietf.org/html/bcp47) format. The [frontend translation files](https://github.com/home-assistant/frontend/tree/dev/master/translations) can also be referred to if you are unsure of the correct language code to use.
