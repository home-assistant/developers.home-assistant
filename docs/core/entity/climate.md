...
| `GOING_TO_SLEEP`  | Device is transitioning toward a sleep profile         |
| `HOME`            | Device is in home mode                                 |
| `NONE`            | No preset is active                                    |
| `SLEEP`           | Device is prepared for sleep                           |
| `VACATION`        | Device is in an extended away or vacation mode         |
| `WAKE`            | Device is transitioning out of sleep toward wake state |
