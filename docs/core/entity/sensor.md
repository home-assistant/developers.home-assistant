...
| native_value | <code>StateType &#124; date &#124; datetime &#124; Decimal</code> | **Required** | The value of the sensor in the sensor's `native_unit_of_measurement`. Using a `device_class` may restrict the types that can be returned by this property.
