...
Local testing is done using [pytest](https://docs.pytest.org/) and using [prek](https://prek.j178.dev/) for running out linters, which has been installed as part of running `script/setup` in the [virtual environment](development_environment.mdx).
