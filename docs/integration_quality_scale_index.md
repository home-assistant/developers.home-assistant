...
- Operations like service calls and entity methods (e.g. *Set HVAC Mode*) have proper exception handling. If user input is invalid raise `ValueError`, otherwise raise `HomeAssistantError`.
