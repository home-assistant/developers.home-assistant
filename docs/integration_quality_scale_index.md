...
- Operations like a service call or entity method (e.g. *Set HVAC Mode*) have proper exception handling. If user input is invalid raise `ValueErorr`, otherwise raise `HomeAssistantError`.
