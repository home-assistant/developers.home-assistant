...
- Avoid excessive use of em dashes (often used by AI). If you use an em dash, use the [Merriam-Webster style](https://www.merriam-webster.com/grammar/em-dash-en-dash-how-to-use), without spaces around the em dash. In general, consider splitting the sentence into shorter sentences. If the em dash is used to introduce a list, use a colon instead.
