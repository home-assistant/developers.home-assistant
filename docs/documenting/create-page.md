...
- `ha_release`: The version number of the release when the integration was included (such as `0.38`). If the current release is `0.37`, make `ha_release` `0.38`. If it's `0.30` or `0.40` please quote it with `' '` (`'0.30'`).
