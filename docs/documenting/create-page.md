...
4. Make sure to add [icon and logo](#images-icons-and-logos) to the brands repository.
   - If your integration was a custom integration (HACS), and you are now creating a core integration, move the brand files out of the custom integration folder into the folder for core integrations.
