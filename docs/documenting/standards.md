...
- Use a serial comma (also known as the Oxford comma) before the conjunction in a list of three or more items. E.g., "Through the use of addtional adapters, Home Assistant allows the use of Zigbee, Z-Wave, and other protocols".
