...
Documentation should follow the [documentation style guide](documenting/general-style-guide.md) and [Microsoft Style Guide](https://learn.microsoft.com/style-guide/welcome/).
