...
1. Delete the related integration documentation page.
2. Remove the related logos and icons from the [Brands repository](https://github.com/home-assistant/brands/t).
