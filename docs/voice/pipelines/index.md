...
| `intent-progress`   | Intermediate update of intent recognition    | depending on conversation agent     | `chat_log_delta` - delta object from the [chat log](/docs/core/entity/conversation#handle-message)                                                                                                                                                                          |
