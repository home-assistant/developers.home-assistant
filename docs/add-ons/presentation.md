...
3. If there isn't a profile for a service, and you want to make one, then do the following:
  a. Add the minimum required access you're aware of. Things you definitely know the service needs
