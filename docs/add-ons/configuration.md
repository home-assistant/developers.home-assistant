...
| snapshot_pre | string | Command to execute in the context of the add-on before the snapshot taken.
| snapshot_post | string | Command to execute in the context of the add-on after the snapshot taken.
