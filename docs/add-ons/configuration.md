...
| full_access | bool | no | Give full access to hardware like the privileged mode in Docker. Works only for not protected add-ons and should not be used! If you using this, you don't need other configs like `uart` or `devices`.
