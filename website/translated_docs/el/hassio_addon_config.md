...
| ----------------- | ----------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| name              | νήμα        | yes      | Name of the add-on                                                                                                                                                                                                                                                                                                                                  |
| version           | νήμα        | yes      | Version of the add-on                                                                                                                                                                                                                                                                                                                               |
| slug              | νήμα        | yes      | Slug of the add-on                                                                                                                                                                                                                                                                                                                                  |
| description       | νήμα        | yes      | Description of the add-on                                                                                                                                                                                                                                                                                                                           |
...
| homeassistant     | νήμα        | no       | Pin a minimun required Home Assistant version for such Add-on. Value is a version string like `0.91.2`.                                                                                                                                                                                                                                             |
...
| image             | νήμα        | no       | For use with Docker Hub and other container registries.                                                                                                                                                                                                                                                                                             |
| timeout           | integer     | no       | Default 10 (second). The timeout to wait until the docker is done or will be killed.                                                                                                                                                                                                                                                                |
| tmpfs             | νήμα        | no       | Mount a tmpfs file system in `/tmpfs`. Valide format for this option is : `size=XXXu,uid=N,rw`. Size is mandatory, valid units (`u`) are `k`, `m` and `g` and `XXX` has to be replaced by a number. `uid=N` (with `N` the uid number) and `rw` are optional.                                                                                        |
...
| ingress_entry     | νήμα        | no       | Modify the URL entry point from `/`.                                                                                                                                                                                                                                                                                                                |
| panel_icon        | νήμα        | no       | Default: mdi:puzzle. MDI icon for the menu panel integration.                                                                                                                                                                                                                                                                                       |
| panel_title       | νήμα        | no       | Default add-on name, but can Modify with this options.                                                                                                                                                                                                                                                                                              |
