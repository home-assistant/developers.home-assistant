...
Library maintainers and custom integrations are adviced to migrate to `pyserial-asyncio-fast`.
...
`pyserial-asyncio-fast`(https://github.com/home-assistant-libs/pyserial-asyncio-fast) was created as a drop-in replacement, and all core integrations have now been migrated.
