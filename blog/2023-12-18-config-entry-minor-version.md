...
More details can be found in the [documentation on config entry migration](/docs/core/integration/config_flow#config-entry-migration) and in [core PR #105749](https://github.com/home-assistant/core/pull/105479).
