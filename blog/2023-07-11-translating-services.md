...
An updated example of a `services.yaml` service description can be [found in our documentation](/docs/dev_101_services#service-action-descriptions). The [backend localization](/docs/internationalization/core#service-actions) has been extended to have an example of a translated service, matching the example from the service description.
